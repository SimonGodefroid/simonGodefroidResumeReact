...
const dataZA01 = [
  { name: "E-Commerce", value: 50, fill: "rgba(255,0,22,1)" },
...
const dataRE01 = [
  { name: "React-Native", value: 60, fill: "rgba(86,89,201,1)" },
  { name: "React", value: 40, fill: "rgba(154,154,220,1)" }
];
const dataRE02 = [
  { subject: "Business Dev.", A: 40, B: 40, fullMark: 150 },
  { subject: "Project Management", A: 100, B: 130, fullMark: 150 },
  { subject: "Information Systems", A: 86, B: 130, fullMark: 150 },
  { subject: "English", A: 120, B: 150, fullMark: 150 },
  { subject: "Mobile App Development", A: 150, B: 150, fullMark: 150 },
  { subject: "Web App Development", A: 130, B: 130, fullMark: 150 }
];
const dataRE03 = [
...
export default class PieChartSkills extends React.Component {
  ...
  render() {
    return (
      <div
        style={{ textAlign: "center", margin: "80px 0 0 20px" }}
        {...chartsHide}
      >
        <div>
