...
let imagesMoveet = [
	...
	},
	{
		...
		alt: 'moveet_landing',
		legend: 'Trouvez les séances pour le film'
	},
	{
	...
	{
		url: './assets/img/moveet_chat_window_lowq.jpg',
		alt: 'moveet_chat',
		legend: 'Partagez votre passion en chattant avec vos buddies'
	},
	{
	...
	{
		url: './assets/img/moveet_loading_lowq.jpg',
		alt: 'moveet_loading',
		legend: 'Patientez, ça arrive !'
	}
];
